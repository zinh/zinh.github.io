...
Một số ví dụ:
- (aa)* : tương đương với ngữ pháp ở ví dụ ①
- (1 \| 0)* : các chuỗi nhị phân
...
Định nghĩa ở trên còn được gọi là Deterministic Finite Automata(DFA), ta còn có Nondeterministic Finite Automata(NFA). NFA tương tự như DFA nhưng có thêm một khái niệm ε-move. Lấy một ví dụ như sau:
